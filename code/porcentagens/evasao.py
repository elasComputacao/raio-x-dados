...
geral = df_alunos.query("periodo_ingresso >= 2000.1").query("forma_evasao != 'GRADUADO'").query("forma_evasao != 'REGULAR'").query("forma_evasao != 'CANCELADO NOVO INGRESSO MESMO CURSO'")
